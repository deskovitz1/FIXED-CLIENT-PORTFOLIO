    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f0f] via-[#1a1a1a] to-[#0f0f0f] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-light mb-4">Welcome</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-medium mb-2">Recent Videos</h3>
              <p className="text-gray-400 text-sm">Latest work and projects</p>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-medium mb-2">Launch Videos</h3>
              <p className="text-gray-400 text-sm">Industry work and launches</p>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-400 text-sm">Music videos and soundtracks</p>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-medium mb-2">BTS</h3>
              <p className="text-gray-400 text-sm">Behind the scenes content</p>
            </div>
          </button>
        </div>
      </main>
